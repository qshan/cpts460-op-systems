...
int find_cmd(char *name)
{
  ...
  else if(strcmp(name, "itimer") == 0)
  {
    return 16;
  }
  else if(strcmp(name, "sgets") == 0)
  {
    return 17;
  }
  else if(strcmp(name, "sputs") == 0)
  {
    return 18;
  }
  else{
...
int sgets()
{
  ...
  printf("proc %d in Umode. from serial = %s\n", getpid(),s);
}
...
int sputs()
{
  ...
  printf("putc syscall for %s\n", s);
  //putc, port, string
  return syscall(18,0,s,0);
}
